# py_runner
Executor of Python codes written for Telegram with Python
## Important points
Please read the license next to the code before using this code
...
Strong log system, with the help of database and text files
The ability to ban a user by the bot manager without reason and with reason
ban and unban feature for bot manager
Relatively strong security scanning system
...
سیستم لاگ قوی، به کمک دیتا بیس و فایلهای متنی
قابلیت بن کردن یک کاربر به وسیله ی مدیر ربات بدون دلیل و با دلیل
قابلیت بن و آن بن برای مدیر ربات
سیستم اسکن امنیتی نسبتاً قوی
